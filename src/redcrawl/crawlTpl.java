 ...
 * @author me
 */
public class crawlTpl extends javax.swing.JFrame {

    private final String USER_AGENT = "Mozilla/5.0 (compatible; Pinterestbot/1.0; +https://www.pinterest.com/bot.html)";
    /**
     *
...
//        //draw image
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ProtectionDomain pd = crawlTpl.class.getProtectionDomain();
...
//            ChromeDriverService driverService = ChromeDriverService.createDefaultService();
            ...
            if (theolink.isSelected()) {
                ...
                try {
                    ...
                    Element link2 = page.selectFirst(".mockup");
                    
                    String url223=link2.attr("src");
                    System.out.println(url223);
                ...
                while ((line = reader.readLine()) != null) {
                    if (!(line.startsWith("*"))) {
                        ...
                        try {
                            ...
                            page = Jsoup.connect(line).userAgent(USER_AGENT).timeout(10 * 1000).get();

                            Elements links = page.select(".styles__link--2sYi3");
                            if (!links.isEmpty()) {
                            ...
                            for (Element link : links) {
                                try {
                                    ...
                                    page = Jsoup.connect(link.attr("href")).userAgent(USER_AGENT).timeout(10 * 1000).get();
                ...
                abc.addWindowListener(new WindowAdapter() {
                    ...
                    public void windowOpened(WindowEvent e) {
                        ...
                        try {
                            ...
                            Logger.getLogger(crawlTpl.class.getName()).log(Level.SEVERE, null, ex);
                        }
