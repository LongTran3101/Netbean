...
//        //draw image
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ProtectionDomain pd = c1.class.getProtectionDomain();
            ...
            URL obj = new URL("http://yeudanba.com/APIRED/index.php?key=" + Key + "&adress=" + adip + "&method=update");
            ...
            String linkAPIget = "http://yeudanba.com/APIRED/get.php?key=" + Key;
...
//            ChromeDriverService driverService = ChromeDriverService.createDefaultService();
            ...
            if (theolink.isSelected()) {
                ...
                try {
                    ...
                    page = Jsoup.connect(textURLForder.getText()).userAgent(USER_AGENT).get();
                    ...
                    a.tag = tag;
                    objSubmid.add(a);
                    HttpPost post = new HttpPost("http://yeudanba.com/APIRED/get2.php");
                ...
                while ((line = reader.readLine()) != null) {
                    if (!(line.startsWith("*"))) {
                        ...
                        try {
                            ...
                            Elements links = page.select("#SearchResultsGrid a img.styles__productImage--3ZNPD");
                            if (!links.isEmpty()) {
                            ...
                            for (Element link : links) {
                                //page = Jsoup.connect(link.attr("href")).userAgent(USER_AGENT).get();
...
//                                    tag = tag + element.attr("title") + ",";
//                                }
                                tag = title.replace(" ", ",") + ",gift,idea,design,quote,sayings,funny,present,humor,birthday,christmas,sarcasm";
                                ...
                                try {
                                    String abcd = urlimage;

                                    String bvcd = abcd.replace("https://ih1.redbubble.net/", "");
                                    int firstIndex = bvcd.indexOf('/');

                                    String urlPngnew = bvcd.substring(0, firstIndex);
                                    String urlFull = "https://ih0.redbubble.net/" + urlPngnew + "/--.u1.png";
                                    //System.out.println(urlFull);
                                    if (!urlFull.contains("image")) {
                                        continue;
                                    }
                                    if(urlFull.contains("data:image"))
                                    {
                                        continue;
                                    }
                                    ...
                                    if (checkresize.isSelected()) {
                                        ...
                                        if (outputImage2.getWidth() > newWidth) {
                                            ...
                                            ImageIO.write(outputImage4, "png", new File(linkSaveFile.getText() + a.getName()));
                                        } else {
                                            int hightwirte = Math.round((newHeight - outputImage2.getHeight()) / 2);
                                            int widthwirte = Math.round((newWidth - outputImage2.getWidth()) / 2);
                                        ...
                                        FileOutputStream fos = new FileOutputStream(linkSaveFile.getText() + a.getName());
                                        fos.write(response2);
                                        fos.close();
...
//                        });
//                        if (!listimagepost.isEmpty()) {
//                            for (int i = 0; i < listimagepost.size(); i++) {
//                                try {
//                                    String a=listimagepost.get(i).getUrl();
//                                    String bvcd = a.replace("https://ih1.redbubble.net/", "");
//                                    int firstIndex = b.indexOf('/');
//                                    
//                                    String urlPngnew=b.substring(0, firstIndex);
//                                    String urlFull="https://ih0.redbubble.net/"+urlPngnew+"/--.u1.png";
//                                    System.out.println("");
//
//                                    URL url = new URL(urlFull);
...
//    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            adip = String.join(",", adress);
            //System.out.println("http://yeudanba.com/APIRED/index.php?key=" + rand + "&adress=" + adip + "&method=create");
            URL obj = new URL("http://yeudanba.com/APIRED/index.php?key=" + rand + "&adress=" + adip + "&method=create");
            HttpURLConnection con = (HttpURLConnection) obj.openConnection();
            con.setRequestMethod("GET");
