 ...
 * @author me
 */
public class hottrendtees extends javax.swing.JFrame {
...
//        //draw image
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ProtectionDomain pd = hottrendtees.class.getProtectionDomain();
...
//            ChromeDriverService driverService = ChromeDriverService.createDefaultService();
            ...
            if (theolink.isSelected()) {
                ...
                try {
                    ...
                    page = Jsoup.connect(textURLForder.getText()).userAgent(USER_AGENT).timeout(10 * 1000).get();
                ...
                while ((line = reader.readLine()) != null) {
                    if (!(line.startsWith("*"))) {
                        ...
                        try {
                            ...
                            Elements links = page.select(".image-fade_in_back a");
                            ...
                            for (Element link : links) {
                                try {
                                    ...
                                    Element link2 = page.selectFirst(".pxg_mockup_media img");
                                    Element listag = page.selectFirst(".tagged_as a");
                                      Element categgory = page.selectFirst(".posted_in a");
                                      Elements decrip = page.select(".tab-panels p");
                                       Element decrip2 = page.selectFirst(".tab-panels h3");
                                       Element decrip1 =decrip.get(0);
                                        Element decrip3 =decrip.get(1);
                                        String tag= listag.text();
                                        System.out.println("tag : "  + tag);
                                        
                                         String des1= decrip1.text();
                                        System.out.println("des1 : "  + des1);
                                          String des2= decrip2.text();
                                        System.out.println("des3 : "  + des2);
                                         String des3= decrip3.text();
                                        System.out.println("des3 : "  + des3);
                                        String cate=categgory.text();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                hottrendtees abc = new hottrendtees();
                abc.addWindowListener(new WindowAdapter() {
                    ...
                    public void windowOpened(WindowEvent e) {
                        ...
                        try {
                            ...
                            Logger.getLogger(hottrendtees.class.getName()).log(Level.SEVERE, null, ex);
                        }
